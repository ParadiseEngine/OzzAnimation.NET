...
namespace OzzAnimation.Offline;
...
public static class AnimationOptimizer
{
    ...
    private static Spec[] BuildHierarchy(RawAnimation raw, ReadOnlySpan<short> parents, Setting setting, IReadOnlyDictionary<int, Setting>? overrides)
    {
